...
public class DreamProjectApplication implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        ImageObject imageObject2 = new ImageObject(defaultImage, targetObject1);
        imageObjectService.save(imageObject2);
        ImageObject imageObject3 = new ImageObject(defaultImage, targetObject1);
        ...
        ImageObject imageObject5 = new ImageObject(defaultImage, targetObject2);
